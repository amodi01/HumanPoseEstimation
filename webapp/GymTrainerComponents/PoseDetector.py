...
class PoseDetector:
    ...
    def getAngle(self, img, p1, p2, p3, landMarkList, draw=True):
        ...
        if draw:
            ...
            cv2.circle(img, (p1_x, p1_y), 5, (0, 0, 255), cv2.FILLED)
            cv2.circle(img, (p1_x, p1_y), 10, (0, 0, 255), 2)
            cv2.circle(img, (p2_x, p2_y), 5, (0, 0, 255), cv2.FILLED)
            cv2.circle(img, (p2_x, p2_y), 10, (0, 0, 255), 2)
            cv2.circle(img, (p3_x, p3_y), 5, (0, 0, 255), cv2.FILLED)
            cv2.circle(img, (p3_x, p3_y), 10, (0, 0, 255), 2)
